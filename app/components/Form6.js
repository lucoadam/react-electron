...
/>
 <div className={styles.maincontainer} data-tid="maincontainer">
    ...
    <form onSubmit={this.handleSubmit}>
      ...
      <br />
      <br />
      <input type="checkbox" name="showNamSariArray" onChange={this.handleCheckboxChange} checked={this.state.showNamSariArray}/>
      <br />
      <div className="infoo">
      ...
      <br />
      <br />
      <input type="checkbox" name="showHakArray" onChange={this.handleCheckboxChange} checked={this.state.showHakArray}/>
      <br />
      <div className="infoo">
      ...
      <br />
      <br />
      <input type="checkbox" name="showfirstPartArray" onChange={this.handleCheckboxChange} checked={this.state.showfirstPartArray}/>
      <br />
      ...
      <br/>
      <br/>
      <input type="checkbox" name="showSecondPartArray" onChange={this.handleCheckboxChange} checked={this.state.showSecondPartArray}/>
      <br />
    ...
    <br/>
      ...
      <br />
      <input type="checkbox" name="showNamSari1Array" onChange={this.handleCheckboxChange} checked={this.state.showNamSari1Array}/>
      <br />
      <div className="infoo">gfd;f/L x'g] hUufsf] lja/0f</div>
      <br />
