...
/>
  ...
  <div className={styles.maincontainer} data-tid="maincontainer">
    ...
    <form onSubmit={this.handleSubmit}>
      ...
      <br />
      <input type="checkbox" name="showMohiArray" onChange={this.handleCheckboxChange} checked={this.state.showMohiArray}/>
      <br />
    ...
    />):('')}
      ...
      <input type="checkbox" name="showMohibadgordArray" onChange={this.handleCheckboxChange} checked={this.state.showMohibadgordArray}/>
      <br />
      <div className="infoo">
      ...
      <br />
      <input type="checkbox" name="showNikayaArray" onChange={this.handleCheckboxChange} checked={this.state.showNikayaArray}/>
      <br />
      <div className="infoo">
      ...
      <br />
      <input type="checkbox" name="showSanlaganArray" onChange={this.handleCheckboxChange} checked={this.state.showSanlaganArray}/>
      <br />
     ...
     />):('')}
      ...
      <br />
      <input type="checkbox" name="showDakhilArray" onChange={this.handleCheckboxChange} checked={this.state.showDakhilArray}/>
      <br />
      <div className="infoo">
      ...
      <br />
      <input type="checkbox" name="showKirtajaggaArray" onChange={this.handleCheckboxChange} checked={this.state.showKirtajaggaArray}/>
      <br />
      <div className="para">
