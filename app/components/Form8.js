...
export default class Form8 extends React.Component {
 ...
 />):('')}
      ...
      <br />
      <input type="checkbox" name="showJagganinaranArray" onChange={this.handleCheckboxChange} checked={this.state.showJagganinaranArray}/>
      <br />
...
/>):('')}
      ...
      <br />
      <input type="checkbox" name="showNamSariJagaArray" onChange={this.handleCheckboxChange} checked={this.state.showNamSariJagaArray}/>
      <br />
      <div className="infoo">df]xL gfd;f/L x'g] hUufsf] lja/0f</div>
