              ...
              <form onSubmit={this.handleSubmit
                ...
                >
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" id="Miti" name="Miti" placeholder="ldlt" />
                  </div>
                </div>
                <br />
                <br />
                ...
                <div className="form-control">
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" id="jaggaoda" name="jaggabibaranOda" />
                      </td>
                      <td>
                        <input type="text" id="jaggakirta" name="jaggabibaranKirta" />
                      </td>
                      <td>
                        <input
                            type="text"
                ...
                <div className="form-control">
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" id="sipahrisdate" name="sipahrisdate" />
                      </td>
                    </tr>
                    </tbody>
                  </table>
                  ...
                  <table>
                    ...
                    <tr>
                      <td>
                        ...
                        ufpFkflnsf÷gu/kflnsf{" "}
                        <input type="text" id="odanumber" name="odanumber" />
                        g++=j8f sfof{"{"}nosf] r g
                        <input type="text" id="chanumber" name="chanumber" />
                        ldlt
                        <input type="text" id="mitti" name="mitti" />
