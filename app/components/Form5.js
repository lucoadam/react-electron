...
/>
   <div className={styles.maincontainer} data-tid="maincontainer">
    ...
    <form onSubmit={this.handleSubmit}>
      ...
      <br />
      <br />
      <input type="checkbox" name="showNirnayaArray" onChange={this.handleCheckboxChange} checked={this.state.showNirnayaArray}/>
      <br />
      ...
      <br />
      <br />
      <input type="checkbox" name="showBibaranArray" onChange={this.handleCheckboxChange} checked={this.state.showBibaranArray}/>
      <br />
