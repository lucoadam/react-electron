...
/>
  <div className={styles.maincontainer} data-tid="maincontainer">
    ...
    <form onSubmit={this.handleSubmit}>
      ...
      <br />
      <input type="checkbox" name="showMemeArray" onChange={this.handleCheckboxChange} checked={this.state.showMemeArray}/>
      <br />
      ...
      <br />
      <input type="checkbox" name="showLastArray" onChange={this.handleCheckboxChange} checked={this.state.showLastArray}/>
      <br />
